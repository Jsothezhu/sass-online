          ...
          >
            ...
            <li class="order-item delete" >
              <a href="javascript:;">
                ...
                <span class="deletd-text" @click="deleteOrder(item.id)">删除</span>
              </a>
            </li>
          </ul>
        </div>
        <div class="noOrder" v-else>
          <img src="../../public/image/norder365.png" alt="">
          <div class="order-alert">哎呦！暂无订单</div>
        </div>
        <el-divider class="line"></el-divider>
        <ul class="foot">
          <li class="foot-item">已选课程<span class="unique">10</span></li>
          <li class="foot-item">合计<span class="unique">2000</span></li>
          <li >
...
import {deleteShopCar, getShopCarList} from '../common/api/car';
...
const goOrder = ()=>{
  router.push({
    path:'/confirmOrder',
    query:{
      courseList:JSON.stringify( orderArr.value )
      //测试一个课程数据
      //courseList:JSON.stringify([{id: '3fab6f4226104dbea4383f2a62530716', number: 1}])
    }
  })
}
//删除订单
